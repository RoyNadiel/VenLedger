                  ...
                  <div className="space-y-2">
                    <div className="flex items-center space-x-2">
                      ...
                      <input
                        ...
                        onChange={(e) => setPaymentCustomRate(e.target.value)}
                        className="w-28 text-xs font-mono border border-zinc-200 dark:border-zinc-700 rounded-md px-2 py-1.5 bg-zinc-50 dark:bg-zinc-800 text-zinc-800 dark:text-zinc-100 outline-hidden"
                      />
                      <button
